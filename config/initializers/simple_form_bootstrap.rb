...
# Custom file: https://github.com/heartcombo/simple_form/pull/1651
...
# components.
# See https://github.com/heartcombo/simple_form#form-components
# to know more about form components.
...
SimpleForm.setup do |config|
  ...
  # bootstrap form forms
  #
  # form input for boolean
  config.wrappers :form_boolean, tag: 'fieldset', class: 'form-group', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.optional :readonly
    b.wrapper :form_check_wrapper, tag: 'div', class: 'form-control form-checkbox' do |bb|
      bb.use :input, class: 'form-control-input', error_class: 'is-invalid'
  ...
  # form input switch for boolean
  config.wrappers :form_boolean_switch, tag: 'fieldset', class: 'form-group', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.optional :readonly
    b.wrapper :form_check_wrapper, tag: 'div', class: 'form-control form-switch' do |bb|
      bb.use :input, class: 'form-control-input', error_class: 'is-invalid'
      bb.use :label, class: 'custom-control-label'
      bb.use :full_error, wrap_with: { tag: 'div', class: 'invalid-feedback' }
      bb.use :hint, wrap_with: { tag: 'small', class: 'form-text text-muted' }
  ...
  config.wrappers :custom_collection_inline, item_wrapper_class: 'form-check form-check-inline', item_label_class: 'custom-control-label', tag: 'fieldset', class: 'form-group', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.optional :readonly
    b.wrapper :legend_tag, tag: 'legend', class: 'form-check-label' do |ba|
      ba.use :label_text
    end
  ...
  # form file input
  config.wrappers :form_file, tag: 'div', class: 'form-group', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
    b.optional :readonly
    b.use :label
    b.wrapper :form_file_wrapper, tag: 'div', class: 'form-file' do |ba|
      ba.use :input, class: 'form-file-input', error_class: 'is-invalid'
      ba.use :label, class: 'form-file-label'
      ba.use :full_error, wrap_with: { tag: 'div', class: 'invalid-feedback' }
    end
    b.use :hint, wrap_with: { tag: 'small', class: 'form-text text-muted' }
  end
  ...
  # form multi select
  config.wrappers :form_multi_select, tag: 'div', class: 'form-group', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.optional :readonly
    b.use :label
    b.wrapper tag: 'div', class: 'd-flex flex-row justify-content-between align-items-center' do |ba|
  ...
  # form range input
  config.wrappers :form_range, tag: 'div', class: 'form-group', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :readonly
    b.optional :step
  ...
  # form multi select
  config.wrappers :floating_labels_select, tag: 'div', class: 'form-floating', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.optional :readonly
    b.use :input, class: 'form-control', error_class: 'is-invalid'
    b.use :label
  ...
  # form wrappers for input types. This should be a hash containing an input
  ...
  # enable form form wrappers
  # config.wrapper_mappings = {
  #   boolean:       :form_boolean,
  #   check_boxes:   :custom_collection,
  #   date:          :form_multi_select,
  #   datetime:      :form_multi_select,
  #   file:          :form_file,
  #   radio_buttons: :custom_collection,
  #   range:         :form_range,
  #   time:          :form_multi_select
  # }
end
